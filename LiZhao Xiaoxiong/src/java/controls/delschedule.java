...
public class delschedule extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for(Schedule sch:schs){
            out.println("<tr><td " + sch.getScheduleID() + "><button data-toggle='modal' data-target='#confirmdelete' class='btn btn-warning' onclick='confirmdelete(" + sch.getScheduleID() + ")'>delete</button>" + 
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            utx.begin();
            EntityManager em = emf.createEntityManager();
            Schedule sch = em.getReference(Schedule.class, delschid);
            em.remove(sch);
            utx.commit();
            em.close();
