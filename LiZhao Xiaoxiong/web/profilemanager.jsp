<%-- 
    ...
    Created on : 19-May-2015, 17:09:27
    Author     : Victor
--%>
...
<div class="container">
    ...
    <div id="wrapper" class="">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav ">
                ...
                <ul class="collapse" id="profiles">
                    <li id="m1">
                        <a href="#" onclick="fmusecase(1)">Create Agency Profile</a>
                    </li>
                    <li id="m2">
                        <a href="#" onclick="fmusecase(2)">Change Agency Profile</a>
                    </li>
                    <li id="m3">
                        <a href="#" onclick="fmusecase(3)">Change Personal Profile</a>
                    </li>         
                </ul>
        ...
        <div class="col-xs-12 col4">
            <div id="sec0" >            
                    <img src="images/profilem.png" class="img-responsive" >
            </div>
            <div id="sec1" >
                <jsp:include page="createagancy.jsp"/>
            </div>
            <div id="sec2" >
            ...
            <div class="modal fade" id="changeAP" role="dialog" >
